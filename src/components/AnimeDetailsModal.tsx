...
export function AnimeDetailsModal({ animeId, onClose }: AnimeDetailsModalProps) { 
    ...
    return (
      ...
      >
        <div className="text-gray-400 text-center">
          ...
          <button
            onClick={onClose}
            className="mt-4 px-4 py-2 bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors inline-block"
          >
            Close
          </button>
        </div>
      ...
      >
        <div className="relative">
          ...
          >
            ...
            <button
              onClick={onClose} // Use onClose prop to close modal
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      {recommendations.map((recommendation: any) => (
                        <div key={recommendation.entry.mal_id} className="bg-gray-800 rounded-lg p-4 flex flex-col">
                          ...
                          {recommendation.entry.images?.webp?.thumb_image_url && (
                            <img
